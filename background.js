...
function buildDigestSystemPrompt(s, preFiltered) {
  return [
    ...
    "- Never invent facts, numbers, outcomes, or specifics about the user's own team, process, or organization (e.g. \"our internal review process\", \"we cut this by 40%\") — you have no knowledge of these. Ground the reply in the post's actual content and general expertise, not fabricated details about the user's own work.",
